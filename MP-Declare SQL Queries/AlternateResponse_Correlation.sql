...
SELECT 'alternate response' AS [Constraint], TaskA, TaskB, a.Param1, b.Param2,
	...
	WHERE a.Task = x.TaskA AND b.Task = x.TaskB AND a.Param1 = b.Param2 AND b.ID IN(SELECT TOP 1 ID
														FROM [Log] b
